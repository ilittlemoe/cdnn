...
// 地址修改成自己的
  . "   <link rel=\"stylesheet\" href=\"跟换成自己的目录地址/404/normalize.min.css\">"
  . "   <link rel=\"stylesheet\" href=\"跟换成自己的目录地址/404/bootstrap.min.css\">"
  . "   <link rel=\"stylesheet\" href=\"跟换成自己的目录地址/404/style.css\">"
  ...
  // 地址修改成自己的
  . "        <li>"
  . "               <a href=\"地址修改成自己的\">Home</a>"
  . "           </li>"
  . "           <li>"
  . "               <a href=\"地址修改成自己的\">留言</a>"
  . "           </li>"
  . "           <li>"
  . "               <a href=\"地址修改成自己的\">音乐</a>"
  . "           </li>"
  . "           <li>"
  . "               <a href=\"地址修改成自己的\">时光机</a>"
  . "           </li>"
  . " </ul>"
  . "   </nav>"
  . "   <main>"
  ...
  . "                   </p>"
  // 地址修改成自己的
  . "                   <button class=\"btn green\"><a href=\"地址修改成自己的\">HOME</a></button>"
  . "                       <p>maybe you want to go <a href=\"地址修改成自己的\">back? </a></p>"
  . "               </div>"
  . "           </div>"
  . "       </div>"
  . "   </main>"
  . "   <!-- partial -->"
// 地址修改成自己的
  . "   <script src=\"跟换成自己的目录地址/404/gsap.min.js.下载\"></script>"
  . "   <script src=\"跟换成自己的目录地址/404/script.js.下载\"></script>"
  . ""
  . "</html>"
?>